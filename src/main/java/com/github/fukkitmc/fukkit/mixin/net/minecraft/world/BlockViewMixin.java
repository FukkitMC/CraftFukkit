...
public interface BlockViewMixin {
	default BlockHitResult fukkit$rayTraceBlock(RayTraceContext raytrace1, BlockPos blockposition) {
		...
		BlockHitResult movingobjectpositionblock = this
		                                           .rayTraceBlock(vec3d, vec3d1, blockposition, voxelshape,
		                                           iblockdata);
		...
		double d0 = movingobjectpositionblock == null ? Double.MAX_VALUE :
		            raytrace1.getStart().squaredDistanceTo(movingobjectpositionblock.getPos());
		double d1 = movingobjectpositionblock1 == null ? Double.MAX_VALUE :
		            raytrace1.getStart().squaredDistanceTo(movingobjectpositionblock1.getPos());
