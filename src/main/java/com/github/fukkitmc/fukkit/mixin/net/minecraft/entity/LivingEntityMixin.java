...
public abstract class LivingEntityMixin extends EntityMixin {
	...
	private int fukkit_visibilityAPI(ServerWorld world, ParticleEffect particle, double x, double y, double z,
	                                 int count, double deltaX, double deltaY, double deltaZ, double speed,
	                                 double heightDifference, boolean onGround, BlockState landedState,
	                                 BlockPos landedPosition) {
		if ((Object) this instanceof ServerPlayerEntity) {
			((ServerWorldAccess) world)
			.spawnParticles((ServerPlayerEntity) (Object) this, new BlockStateParticleEffect(ParticleTypes.BLOCK,
			landedState), this
			                                                                                                                    .getX(), this
			                                                                                                                             .getY(), this
			                                                                                                                                      .getZ(), count, 0, 0, 0, .15, false);
		} else {
			world.spawnParticles(new BlockStateParticleEffect(ParticleTypes.BLOCK, landedState), this.getX(), this
			                                                                                                  .getY(),
			this
			                                                                                                           .getZ(), count, 0, 0, 0, .15);
		}
	...
	@Inject (method = "updatePostDeath",
	         at = @At (value = "INVOKE", target = "Lnet/minecraft/entity/LivingEntity;remove()V"))
	...
	private void fukkit_potionEvent(LivingEntity entity, StatusEffectInstance effect) {
		...
		this.iterator = null;
		EntityPotionEffectEvent event = CraftEventFactory
		                                .callEntityPotionEffectChangeEvent((LivingEntity) (Object) this, effect, null,
	...
	@Inject (method = "tickStatusEffects",
	         at = @At (value = "FIELD", target = "Lnet/minecraft/entity/LivingEntity;effectsChanged:Z"))
	private void fukkit_process(CallbackInfo ci) {
		this.isTickingEffects = false;
		for (EntityUtil.ProcessableEffect process : this.effectsToProcess) {
			if (process.getEffect() != null) { this.fukkit$addEffect(process.getEffect(), process.getCause()); } else {
				this.fukkit$removeEffect(process.getType(), process.getCause());
			}
		}
	}
	...
	@Redirect (method = "damage",
	           at = @At (value = "INVOKE", target = "Lnet/minecraft/entity/LivingEntity;getHealth()F", ordinal = 0))
	...
	@ModifyVariable (method = "damage", at = @At (value = "INVOKE",
	                                              target = "Lnet/minecraft/entity/LivingEntity;blockedByShield" +
	...
	@Inject (method = "damage", at = @At (value = "RETURN", ordinal = 0), slice = @Slice (
	from = @At (value = "FIELD", target = "Lnet/minecraft/entity/LivingEntity;lastDamageTaken:F", ordinal = 0)))
	...
	// 2 birds 1 stone
	@Redirect (method = "damage", at = @At (value = "INVOKE",
	                                        target = "Lnet/minecraft/entity/LivingEntity;applyDamage" +
	                                                 "(Lnet/minecraft/entity/damage/DamageSource;F)V"))
	...
	@Inject (method = "damage",
	         at = @At (value = "FIELD", target = "Lnet/minecraft/entity/LivingEntity;lastDamageTaken:F", ordinal = 1,
	...
	@Inject (method = "damage",
	         at = @At (value = "FIELD", target = "Lnet/minecraft/entity/LivingEntity;knockbackVelocity:F",
	...
	@Redirect (method = "tryUseTotem", at = @At (value = "INVOKE",
	                                             target = "Lnet/minecraft/entity/LivingEntity;getStackInHand" +
	                                                      "(Lnet/minecraft/util/Hand;)Lnet/minecraft/item/ItemStack;"))
	...
	@ModifyVariable (method = "tryUseTotem", at = @At (value = "LOAD"), slice = @Slice (
	from = @At (value = "INVOKE", target = "Lnet/minecraft/item/ItemStack;decrement(I)V"),
	to = @At (value = "JUMP", opcode = Opcodes.IFNULL, ordinal = 0)), index = 4, ordinal = 0)
	private net.minecraft.item.ItemStack fukkit_temp(net.minecraft.item.ItemStack stack) {
		EntityResurrectEvent event =
		new EntityResurrectEvent((org.bukkit.entity.LivingEntity) this.fukkit$getBukkit());
	...
	@Redirect (method = "tryUseTotem", at = @At (value = "INVOKE",
	                                             target = "Lnet/minecraft/entity/LivingEntity;addStatusEffect" +
	                                                      "(Lnet/minecraft/entity/effect/StatusEffectInstance;)Z"))
	...
	@Inject (method = "drop",
	         at = @At (value = "INVOKE", target = "Lnet/minecraft/entity/LivingEntity;canDropLootAndXp()Z"))
	...
	@Inject (method = "drop", at = @At (value = "INVOKE",
	                                    target = "Lnet/minecraft/entity/LivingEntity;dropEquipment" +
	                                             "(Lnet/minecraft/entity/damage/DamageSource;IZ)V",
	...
	public void dropXp() {
		...
		while (toDrop > 0) {
			...
			toDrop -= rounded;
			this.world.spawnEntity(new ExperienceOrbEntity(this.world, this.getX(), this.getY(), this.getZ(),
			rounded));
		}
		this.expToDrop = 0;
	}

	@Inject (method = "handleFallDamage", at = @At (value = "INVOKE",
	                                                target = "Lnet/minecraft/entity/LivingEntity;playSound" +
	                                                         "(Lnet/minecraft/sound/SoundEvent;FF)V"),
	         cancellable = true, locals = LocalCapture.CAPTURE_FAILHARD)
	private void fukkit_damage(float fallDistance, float damageMultiplier, CallbackInfoReturnable<Boolean> cir,
	                           boolean bl, int computed) {
	...
	@Redirect (method = "handleFallDamage", at = @At (value = "INVOKE",
	...
	@Redirect (method = "applyArmorToDamage",
	...
	@Redirect (method = "applyEnchantmentsToDamage", at = @At (value = "INVOKE",
	                                                           target = "Lnet/minecraft/entity/LivingEntity;" +
	                                                                    "hasStatusEffect(Lnet/minecraft/entity/effect" +
	                                                                    "/StatusEffect;)Z"))
	...
	@Inject (method = "getAttributes", at = @At (value = "FIELD",
	                                             target = "Lnet/minecraft/entity/LivingEntity;" +
	                                                      "attributes:Lnet/minecraft/entity/attribute" +
	...
	private void fukkit_toggleGlide(LivingEntity entity, int index, boolean value) {
		if (this.getFlag(7 /* yay magic numbers */) && !CraftEventFactory
		                                                .callToggleGlideEvent((LivingEntity) (Object) this, false)
		                                                .isCancelled()) { this.setFlag(7, false); }
	}

	@Redirect (method = "initAi",
	           at = @At (value = "INVOKE", target = "Lnet/minecraft/entity/LivingEntity;setFlag(IZ)V"))
	private void fukkit_toggleGlide0(LivingEntity entity, int index, boolean value) {
		if (value ^ this.getFlag(7) && !CraftEventFactory.callToggleGlideEvent((LivingEntity) (Object) this, value)
		                                                 .isCancelled()) { this.setFlag(7, value); }
	}
	...
	@Inject (method = "consumeItem", at = @At (value = "INVOKE",
	                                           target = "Lnet/minecraft/item/ItemStack;finishUsing" +
	...
	private void fukkit_consumeEvent(CallbackInfo ci) {
		...
		if ((Object) this instanceof ServerPlayerEntity) {
			...
			stacc =
			craft.equals(event.getItem()) ? this.activeItemStack.finishUsing(this.world,
			(LivingEntity) (Object) this) :
			CraftItemStack.asNMSCopy(event.getItem()).finishUsing(this.world, (LivingEntity) (Object) this);
		} else {
	...
	@Redirect (method = "consumeItem", at = @At (value = "INVOKE",
	...
	@Inject (method = "teleport", at = @At (value = "INVOKE",
	...
	private void fukkit_teleportEvent(double x, double y, double z, boolean particleEffects, CallbackInfoReturnable<Boolean> cir, double tx, double ty, double tz, double y2, boolean bl, BlockPos pos, World world, boolean bl2) {
		...
		EntityTeleportEvent event = new EntityPortalEvent((org.bukkit.entity.Entity) this
		                                                                             .fukkit$getBukkit(), new Location(craft, tx, ty, tz), new Location(craft, x, y, z));
		((WorldAccess) this.world).getBukkitServer().getPluginManager().callEvent(event);
		if (!event.isCancelled()) {
	...
	@Redirect (method = "teleport",
	           at = @At (value = "INVOKE", target = "Lnet/minecraft/entity/LivingEntity;requestTeleport(DDD)V"))
	...
	@Redirect (method = "teleport", at = @At (value = "INVOKE",
	                                          target = "Lnet/minecraft/world/World;containsFluid(Lnet/minecraft/util/math/Box;)Z"))
	private boolean fukkit_true(World world, Box box) {
		return false;
	}

	@Redirect (method = "applyFoodEffects", at = @At (value = "INVOKE",
	...
	public boolean fukkit$removeAllEffects(EntityPotionEffectEvent.Cause cause) {
		...
		if (this.world.isClient) {
			...
			for (flag = false; iterator.hasNext(); flag = true) {
				...
				EntityPotionEffectEvent event = CraftEventFactory
				                                .callEntityPotionEffectChangeEvent((LivingEntity) (Object) this,
				                                effect, null, cause, EntityPotionEffectEvent.Action.CLEARED);
				if (event.isCancelled()) {
					continue;
				}
				this.onStatusEffectRemoved(effect);
	...
	public boolean fukkit$addEffect(StatusEffectInstance effect, EntityPotionEffectEvent.Cause cause) {
		...
		if (!this.canHaveStatusEffect(effect)) {
			...
			EntityPotionEffectEvent event = CraftEventFactory
			                                .callEntityPotionEffectChangeEvent((LivingEntity) (Object) this, newType,
			                                effect, cause, override);
			if (event.isCancelled()) {
				return false;
			}
	...
	public StatusEffectInstance fukkit$removeStatusEffectInternal(StatusEffect effect,
		...
		EntityPotionEffectEvent event = CraftEventFactory
		                                .callEntityPotionEffectChangeEvent((LivingEntity) (Object) this, active, null,
		                                cause);
		if (event.isCancelled()) {
			return null;
		}
	...
	public void fukkit$heal(float f, EntityRegainHealthEvent.RegainReason regainReason) {
		...
		if (f1 > 0.0F) {
			EntityRegainHealthEvent event = new EntityRegainHealthEvent(((LivingEntityAccess<?>) this)
			                                                            .getBukkit(), f, regainReason);
	...
	public int fukkit$getExpReward() {
		if (!this.world.isClient && (this.shouldAlwaysDropXp() || this.playerHitTimer > 0 && this
		                                                                                     .canDropLootAndXp() && this.world
		                                                                                                            .getGameRules()
	...
	public boolean fukkit$damage0(final DamageSource source, float f) { // void -> boolean, add final
		if (!this.isInvulnerableTo(source)) {
			...
			Function<Double, Double> hardHat = f12 -> {
				if ((source == DamageSource.ANVIL || source == DamageSource.FALLING_BLOCK) && !this
			...
			Function<Double, Double> resistance = f15 -> {
				if (!source.isUnblockable() && this
				                               .hasStatusEffect(StatusEffects.RESISTANCE) && source != DamageSource.OUT_OF_WORLD) {
			...
			Function<Double, Double> absorption = f17 -> -(Math.max(f17 - Math.max(f17 - this
			                                                                             .getAbsorptionAmount(), 0.0F)
			, 0.0F));
			float absorptionModifier = absorption.apply((double) f).floatValue();

			EntityDamageEvent event = CraftEventFactory
			                          .handleLivingEntityDamageEvent((LivingEntity) (Object) this, source,
			                          originalDamage, hardHatModifier, blockingModifier, armorModifier,
			                          resistanceModifier, magicModifier, absorptionModifier, hardHat, blocking, armor,
			...
			if (event.getDamage(EntityDamageEvent.DamageModifier.RESISTANCE) < 0) {
				...
				if (f3 > 0.0F && f3 < 3.4028235E37F) {
					if ((Object) this instanceof ServerPlayerEntity) {
						...
						.increaseStat(Stats.DAMAGE_RESISTED, Math.round(f3 * 10.0F));
					} else if (source.getAttacker() instanceof ServerPlayerEntity) {
						((ServerPlayerEntity) source.getAttacker())
						.increaseStat(Stats.DAMAGE_DEALT_RESISTED, Math.round(f3 * 10.0F));
					}
				}
			}
			...
			if ((source == DamageSource.ANVIL || source == DamageSource.FALLING_BLOCK) && this
			                                                                              .getEquippedStack(EquipmentSlot.HEAD) != null) {
				this.getEquippedStack(EquipmentSlot.HEAD)
				    .damage((int) (event.getDamage() * 4.0F + this.random.nextFloat() * event
				                                                                        .getDamage() * 2.0F),
				    (LivingEntity) (Object) this, (living) -> {
			...
			if (!source.bypassesArmor()) {
				float armorDamage = (float) (event.getDamage() + event
				                                                 .getDamage(EntityDamageEvent.DamageModifier.BLOCKING) + event
				                                                                                                         .getDamage(EntityDamageEvent.DamageModifier.HARD_HAT));
			...
			if (event.getDamage(EntityDamageEvent.DamageModifier.BLOCKING) < 0) {
				this.world
				.sendEntityStatus((LivingEntity) (Object) this, (byte) 29); // SPIGOT-4635 - shield damage sound
			...
			if (f2 > 0.0F && f2 < 3.4028235E37F && source.getAttacker() instanceof ServerPlayerEntity) {
				((ServerPlayerEntity) source.getAttacker())
				.increaseStat(Stats.DAMAGE_DEALT_ABSORBED, Math.round(f2 * 10.0F));
			}
			...
			if (f > 0 || !human) {
				...
				if (event.getDamage(EntityDamageEvent.DamageModifier.BLOCKING) < 0) {
					if ((Object) this instanceof ServerPlayerEntity) {
						Criterions.ENTITY_HURT_PLAYER
						.trigger((ServerPlayerEntity) (Object) this, source, f, originalDamage, true);
						f2 = (float) -event.getDamage(EntityDamageEvent.DamageModifier.BLOCKING);
						if (f2 > 0.0F && f2 < 3.4028235E37F) {
							((ServerPlayerEntity) (Object) this)
							.increaseStat(Stats.DAMAGE_BLOCKED_BY_SHIELD, Math.round(originalDamage * 10.0F));
						}
					}

					if (source.getAttacker() instanceof ServerPlayerEntity) {
						Criterions.PLAYER_HURT_ENTITY.trigger((ServerPlayerEntity) source
						                                                           .getAttacker(),
						(Entity) (Object) this, source, f, originalDamage, true);
					}
