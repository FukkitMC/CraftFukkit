...
public class PlayerAdvancementTrackerMixin {
	...
	@Redirect(method = "load()V", at = @At(value = "INVOKE", target = "Lorg/apache/logging/log4j/Logger;warn(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V", remap = false))
