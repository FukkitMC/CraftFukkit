...
public interface ServerWorldAccess extends WorldAccess {
	...
	<T extends ParticleEffect> int spawnParticles(ServerPlayerEntity entity, T particle, double x, double y, double z, int count, double deltaX, double deltaY, double deltaZ, double speed, boolean force);
